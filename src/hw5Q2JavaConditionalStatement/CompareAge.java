...
public class CompareAge {
	...
	int ageOfJenifer=21;
	 ...
	 ageOfJenifer+", the age of Jenifer.");
		 ...
		 System.out.println("Alex is"+ageOfAlex+"which is an even number and they are same age."+
	 ageOfJenifer+", the age of Jenifer.");
	 }else if(ageOfAlex%2==1 && (ageOfAlex!=ageOfJenifer)) {
		 System.out.println("Alex is"+ageOfAlex+"which is an odd number and they are not same age."+
	 ageOfJenifer+", the age of Jenifer.");
	 }else if(ageOfAlex%2!=0 && (ageOfAlex!=ageOfJenifer)) {
		 System.out.println("Alex is"+ageOfAlex+"which is not an even number and they are not same age."+
	 ageOfJenifer+", the age of Jenifer.");
	 }else if(ageOfAlex%2==0 && (ageOfAlex==ageOfJenifer) || (ageOfAlex>ageOfJenifer)) {
		 System.out.println("Alex is"+ageOfAlex+"which is an even number and they are the same age or (Alex may be older)."+ageOfJenifer+", the age of Jenifer.");
	 } else if(ageOfAlex%2==0 && (ageOfAlex==ageOfJenifer) || (ageOfAlex<ageOfJenifer)) {
